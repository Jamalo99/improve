...
class ProbabilityController extends Controller
{
    public function index()
    {
        ...
        return view('admin.probabilities.index', compact('probabilities'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.probabilities.create');
    }
    ...
    public function edit(Probability $probability)
    {
        ...
        return view('admin.probabilities.edit', compact('probability'));
    }
    ...
    public function show(Probability $probability)
    {
        ...
        return view('admin.probabilities.show', compact('probability'));
    }
