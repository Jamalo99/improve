...
class CadenceController extends Controller
{
    public function index()
    {
        ...
        return view('admin.cadences.index', compact('cadences'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.cadences.create');
    }
    ...
    public function store(StoreCadenceRequest $request)
    {
        ...
        return redirect()->route('admin.cadences.index');
    }
    ...
    public function edit(Cadence $cadence)
    {
        ...
        return view('admin.cadences.edit', compact('cadence'));
    }
    ...
    public function show(Cadence $cadence)
    {
        ...
        return view('admin.cadences.show', compact('cadence'));
    }
