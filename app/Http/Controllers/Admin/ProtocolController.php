...
class ProtocolController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.protocols.create', compact('capitals', 'macroprocesses', 'statuses', 'workspaces'));
    }
    ...
    public function edit(Protocol $protocol)
    {
        ...
        return view('admin.protocols.edit', compact('capitals', 'macroprocesses', 'protocol', 'statuses', 'workspaces'));
    }
