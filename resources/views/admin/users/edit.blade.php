...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_sub_user') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="is_sub_user" value="0">
                    <input class="form-check-input" type="checkbox" name="is_sub_user" id="is_sub_user" value="1" {{ $user->is_sub_user || old('is_sub_user', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="is_sub_user">{{ trans('cruds.user.fields.is_sub_user') }}</label>
                </div>
