...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.risk-maps.update", [$riskMap->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('risk_owner') ? 'is-invalid' : '' }}" type="text" name="risk_owner" id="risk_owner" value="{{ old('risk_owner', $riskMap->risk_owner) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desc_risk') ? 'is-invalid' : '' }}" type="text" name="desc_risk" id="desc_risk" value="{{ old('desc_risk', $riskMap->desc_risk) }}">
