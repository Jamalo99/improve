                        ...
                        <tr data-entry-id="{{ $fraudAnswer->id }}">
                            ...
                            <td>
                                ...
                                @can('fraud_answer_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.fraud-answers.edit', $fraudAnswer->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('fraud_answer_delete')
                                    <form action="{{ route('admin.fraud-answers.destroy', $fraudAnswer->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('fraud_answer_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.fraud-answers.massDestroy') }}",
