                        ...
                        <tr data-entry-id="{{ $protocolTableQuestion->id }}">
                            ...
                            <td>
                                ...
                                @can('protocol_table_question_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.protocol-table-questions.edit', $protocolTableQuestion->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('protocol_table_question_delete')
                                    <form action="{{ route('admin.protocol-table-questions.destroy', $protocolTableQuestion->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('protocol_table_question_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.protocol-table-questions.massDestroy') }}",
