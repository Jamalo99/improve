...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.protocol-table-questions.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desc_activity') ? 'is-invalid' : '' }}" type="text" name="desc_activity" id="desc_activity" value="{{ old('desc_activity', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desc_control') ? 'is-invalid' : '' }}" type="text" name="desc_control" id="desc_control" value="{{ old('desc_control', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('support_info') ? 'is-invalid' : '' }}" type="text" name="support_info" id="support_info" value="{{ old('support_info', '') }}">
