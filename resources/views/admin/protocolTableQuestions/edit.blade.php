...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.protocol-table-questions.update", [$protocolTableQuestion->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="protocol_id">{{ trans('cruds.protocolTableQuestion.fields.protocol') }}</label>
                <select class="form-control select2 {{ $errors->has('protocol') ? 'is-invalid' : '' }}" name="protocol_id" id="protocol_id" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desc_activity') ? 'is-invalid' : '' }}" type="text" name="desc_activity" id="desc_activity" value="{{ old('desc_activity', $protocolTableQuestion->desc_activity) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desc_control') ? 'is-invalid' : '' }}" type="text" name="desc_control" id="desc_control" value="{{ old('desc_control', $protocolTableQuestion->desc_control) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('support_info') ? 'is-invalid' : '' }}" type="text" name="support_info" id="support_info" value="{{ old('support_info', $protocolTableQuestion->support_info) }}">
