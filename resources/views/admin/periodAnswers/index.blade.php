                        ...
                        <tr data-entry-id="{{ $periodAnswer->id }}">
                            ...
                            <td>
                                ...
                                @can('period_answer_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.period-answers.edit', $periodAnswer->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('period_answer_delete')
                                    <form action="{{ route('admin.period-answers.destroy', $periodAnswer->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('period_answer_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.period-answers.massDestroy') }}",
