    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.activities.update", [$activity->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $activity->title) }}" required>
                @if($errors->has('title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description_activity') ? 'is-invalid' : '' }}" type="text" name="description_activity" id="description_activity" value="{{ old('description_activity', $activity->description_activity) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description_control') ? 'is-invalid' : '' }}" type="text" name="description_control" id="description_control" value="{{ old('description_control', $activity->description_control) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ctr') ? 'is-invalid' : '' }}" type="text" name="ctr" id="ctr" value="{{ old('ctr', $activity->ctr) }}">
                @if($errors->has('ctr'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ctr') }}
                    </div>
