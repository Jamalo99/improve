...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.protocols.update", [$protocol->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $protocol->title) }}" required>
                @if($errors->has('title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('index') ? 'is-invalid' : '' }}" type="text" name="index" id="index" value="{{ old('index', $protocol->index) }}" required>
                @if($errors->has('index'))
                    <div class="invalid-feedback">
                        {{ $errors->first('index') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('control_manager') ? 'is-invalid' : '' }}" type="text" name="control_manager" id="control_manager" value="{{ old('control_manager', $protocol->control_manager) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('control_deputy') ? 'is-invalid' : '' }}" type="text" name="control_deputy" id="control_deputy" value="{{ old('control_deputy', $protocol->control_deputy) }}">
