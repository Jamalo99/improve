                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.activities.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description_activity" id="description_activity" value="{{ old('description_activity', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description_control" id="description_control" value="{{ old('description_control', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ctr" id="ctr" value="{{ old('ctr', '') }}">
                            @if($errors->has('ctr'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ctr') }}
                                </div>
